...
namespace WindowsFormsApp1
{
    public partial class loginbackoffice : Form
    {
        ...
        private void butlogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string query = "SELECT * FROM [user] WHERE user_name = @username AND user_password = @password AND account_type='admin'";
                    ...
                    if (reader.HasRows)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(connstring))
                        {
                            ...
                            string insert = @"INSERT INTO [tem_login] (user_name, password,system) VALUES (@user_name, @password,'BackOfiice')";
        ...
        private void loginbackoffice_Load(object sender, EventArgs e)
        {
